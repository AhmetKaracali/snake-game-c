...
void DisplayScreen()
{
   ...
   glRectf(bonusFood[0],bonusFood[1],bonusFood[0]+CellSize,bonusFood[1]+CellSize);
...
void printText()
{
   ...
   glColor3f(1.000, 0.500, 0.000);
    renderBitmapString(24.0f, 70.0f, (void *)font, "--- Snake Game ---");
...
if(mainStack==2)
{
 ...
 else if(helpmenu==1)
   {
    ...
    glColor3f(0.545, 1.000, 0.000);
    renderBitmapString(1.0f, 40.0f, (void *)font, "You can use W,A,S,D for control the snake and menu.");
    renderBitmapString(10.0f, 35.0f, (void *)font, "Press ENTER for execute and press ESC to exit...");
...
{
    glColor3f(0.545, 1.000, 0.000);
    renderBitmapString(30.0f, 50.0f, (void *)font, "Easy");
    glColor3f(1.0, 1.00, 1.000);
    renderBitmapString(30.0f, 45.0f, (void *)font, "Medium");
    renderBitmapString(30.0f, 40.0f, (void *)font, "Hard");
    ...
    if(levelStack==1)
{
    ...
    renderBitmapString(30.0f, 60.0f, (void *)font, "! GAME OVER !");
    glColor3f(0.000, 0.000, 1.000);
    renderBitmapString(25.0f, 50.0f, (void *)font, "Your Score :");
...
int main(int argc, char **argv)
{
    ...
    window = glutCreateWindow("You should crash snake's head when the snake is still little");
